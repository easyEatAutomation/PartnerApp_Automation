...
private By CompleteTakeAwayOrer = By.xpath("/html/body/app-root/body/div/div[2]/div[2]/app-order/div/div[2]/div[3]/app-order-right/div/div[3]/div[2]/button[2]");
	...
	public void CreateOrderButton() throws InterruptedException {
		...
		public void TakeAwayButton () throws InterruptedException {
			...
			clickOnElement(TakeAwayButton, "Clicked on Take Away button", 10000);
			Thread.sleep(1500);
		}
		
		public void ItemName() throws InterruptedException {

			clickOnElement(ItemName, "Item Name", 1000);
			Thread.sleep(1500);
	...
	public void CompleteTakeAwayOrer()throws InterruptedException {
		...
		clickOnElement(CompleteTakeAwayOrer,"Complete Take Away Orer", 1000);
	}
	
	public void PastOrderTab() throws InterruptedException {

		clickOnElement(PastOrderTab,"PastOrderTab", 1000);
	}
	
	public void RevertOrderButton() throws InterruptedException {

		clickOnElement(RevertOrderButton,"RevertOrderButton", 1000);
	}
	
	public void YesDeleteButton() throws InterruptedException {

		clickOnElement(YesDeleteButton,"YesDeleteButton", 1000);
	}
}
