...
clickOnElement(CreateOrderButton, "Clicked on Create Order", 100);
	}
		...
		public void DineIn() throws InterruptedException {
			...
			clickOnElement(DineIn, "Clicked on Dine In Button", 1000);
		}
	...
	public void ItemNameB() throws InterruptedException {
		clickOnElement(ItemNameB, "Selected ItemB", 1000);
		Thread.sleep(1500);
		}
		...
		public void selectTable() throws InterruptedException {
			...
			clickOnElement(selectTable, " DineIn Table Selected for order completion", 1000);
			Thread.sleep(1500);
	...
	{
		clickOnElement(SettleBillOnDineIn, "Clicked on Settle Bill On DineIn", 1000);
		Thread.sleep(7000);
	...
	{
		clickOnElement(DineInCashPayment, "Selected CashPayment Option", 1000);

	}


	public void CompleteOrder()throws InterruptedException{
		clickOnElement(CompleteOrder, "Clicked on CompleteOrder button", 1000);
		Thread.sleep(3000);
	}
	...
	public void PaymentChangeLink() throws InterruptedException {
		clickOnElement(PaymentChangeLink, "PaymentChangeLink", 1000);
		Thread.sleep(1500);
	...
	public void PaymentDeleteLink() throws InterruptedException {
		clickOnElement(PaymentDeleteLink, "PaymentDeleteLink", 1000);
		Thread.sleep(3000);
	...
	public void Deletebuttonconfirmation()throws InterruptedException {
		clickOnElement(Deletebuttonconfirmation, "Deletebuttonconfirmation", 1000);
		Thread.sleep(2000);

	
	}
	public void SelectMasterCard()throws InterruptedException {
		clickOnElement(SelectMasterCard, "SelectMasterCard", 1000);
		Thread.sleep(2000);

		
}
	public void PayRMbuttononPopup()throws InterruptedException {
		clickOnElement(PayRMbuttononPopup, "PayRMbuttononPopup", 1000);
	

	}
	
	public void DoneButton()throws InterruptedException {
		clickOnElement(DoneButton, "DoneButton", 1000);
